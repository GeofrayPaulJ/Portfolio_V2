...
* **Profiling:** Profiled training loops with NVIDIA Nsight Systems, AMP and DDP, capturing a narrow mid-training window (`nsys profile --delay --duration`) every 50 epochs rather than profiling whole runs.
